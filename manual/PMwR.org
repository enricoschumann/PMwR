...
* About PMwR
  ...
  is currently under development and changes frequently. So, the
  manual is a draft, so be please do not quote it. I am grateful
  for comments.
...
You could check your drinking habits for patterns, say.
