...
<p>
    ...
    <time datetime="2016-02-18">18 February 2016</time>&nbsp;&nbsp;&nbsp;
...
To replace the lost intial observation, specify =pad=.
#+BEGIN_SRC R -n :exports both :results output
returns(x, pad = 0)
returns(x, pad = NA)
#+END_SRC 
...
:  
:                 x       x       x
: 2015-01-05  0.0000  0.0000  0.0000
: 2015-01-06  0.0200  0.0200  0.0200
: 2015-01-07 -0.0098 -0.0098 -0.0098
...
attributes and class =p_returns=. Most useful is a =print=
method.
#+BEGIN_SRC R -n :exports both :results output
...
#+RESULTS:
: 8.5%  [01 Nov 2014 -- 20 Jan 2015; less than one year, not annualised]
: 8.5%  [01 Nov 2014 -- 20 Jan 2015; less than one year, not annualised]

But note that the function did /not/ annualise: it does not
annualise if the time period is shorter than one year.
#+BEGIN_SRC R -n :exports both :results output
x[length(x)]/x[1] - 1
#+END_SRC 
...
#+RESULTS:
: 45.3%  [01 Nov 2014 -- 20 Jan 2015; less than one year, but annualised]
...
of information, stored in attributes.
